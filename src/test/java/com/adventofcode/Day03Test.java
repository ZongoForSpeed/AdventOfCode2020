...
public class Day03Test {
    ...
    public static long checkAllTobogganTrajectories(List<String> map) {
        long result = 1;
        result *= tobogganTrajectory(map, 1, 1);
        result *= tobogganTrajectory(map, 3, 1);
        result *= tobogganTrajectory(map, 5, 1);
        result *= tobogganTrajectory(map, 7, 1);
        result *= tobogganTrajectory(map, 1, 2);
    ...
    void testTobogganTrajectory() {
        ...
        assertThat(tobogganTrajectory(map, 1, 1)).isEqualTo(2);
        assertThat(tobogganTrajectory(map, 3, 1)).isEqualTo(7);
        assertThat(tobogganTrajectory(map, 5, 1)).isEqualTo(3);
        assertThat(tobogganTrajectory(map, 7, 1)).isEqualTo(4);
        assertThat(tobogganTrajectory(map, 1, 2)).isEqualTo(2);

        assertThat(checkAllTobogganTrajectories(map)).isEqualTo(336);
    ...
    void inputTobogganTrajectory() throws IOException {
        ...
        assertThat(tobogganTrajectory(lines, 3, 1))
                .isEqualTo(234);

        assertThat(checkAllTobogganTrajectories(lines)).isEqualTo(5813773056L);
    }
}
