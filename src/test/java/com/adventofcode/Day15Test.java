...
public class Day15Test {
    ...
    long memoryGame(String input, int turn) {
        Map<Long, Integer> lastMemory = new HashMap<>();
        Map<Long, Integer> previousMemory = new HashMap<>();

        long[] startingNumbers = Arrays.stream(input.split(",")).mapToLong(Long::parseLong).toArray();
        int n = 1;
